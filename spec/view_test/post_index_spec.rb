...
RSpec.feature 'Post Index Page', type: :feature do
  before do
    ...
    @posta = Post.create(author: @user, title: 'Post franck', text: 'This is the content of Post', comments_counter: 2,
                         likes_counter: 0)

    # Create some posts for the user
    @posts = []
    3.times do |i|
      @posts << Post.create(author: @user, title: "Post ##{i + 1}", text: "This is the content of Post ##{i + 1}",
  ...
  scenario 'Displays the post index page correctly' do
    ...
    @posts.each_with_index do |post, _idx|
